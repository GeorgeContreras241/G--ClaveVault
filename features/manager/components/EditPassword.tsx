...
export const EditPassword = ({ password, onClose }: EditPasswordProps) => {
    ...
    const [originalKeys] = useState({ ...keys })
        ...
        <section className="vault-panel rounded-xl p-4">
            <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
                <div className="flex items-center justify-between">
                    <label className="font-sora text-sm font-semibold">Editar Contraseña</label>
                    <button
                        type="button"
                ...
                {isFormVisible && (
                    <>
                        <div>
                            ...
                            <input type="text" placeholder="Título" value={keys.title}
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Usuario" value={keys.username}
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="https://ejemplo.com" value={keys.url}
                                onChange={(e) => { setKeys({ ...keys, url: e.target.value }); if (errors.url) setErrors({ ...errors, url: undefined }) }}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type={showPassword ? "text" : "password"} placeholder="Contraseña" value={keys.password}
                            ...
                            {isConfigVisible && (
                                <>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <input type="number" min="4" max="32" value={passwordOptions.length}
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {([
                                            ...
                                            <label key={key} className="flex items-center gap-1.5 text-xs text-muted-foreground cursor-pointer">
                                                <input type="checkbox" checked={passwordOptions[key]}
                        ...
                        <div className="flex gap-2">
                            <Button className="flex-1 py-1.5 text-sm">Guardar Cambios</Button>
                            <Button type="button" onClick={onClose} className="flex-1 py-1.5 text-sm bg-secondary text-secondary-foreground">Cancelar</Button>
                        </div>
                    </>
                )}
            </form>
